...
access to information, they do so in an inherently insecure way. We also
...
MaidSafe proposes and implements a new architecture that eliminates human involvement in private data.  Hence we enable 
